...
<section>
    <header class="d-flex flex-column align-items-center py-3 px-2 mb-4">
        <h2 class="order-2 fs-1 fw-bolder text-center txt-rafitu">Votre premier choix pour voyager partout</h2>
        <h3 class="order-1 fs-1 txt-rafitu">Bienvenue chez Rafitu</h3>
    </header>
    <main>
        <div class="row my-5">
            <div class="col-12 col-lg-6 px-md-0 p-1">
