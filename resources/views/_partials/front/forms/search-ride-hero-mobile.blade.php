            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-search-ride-hero" action="{{ route('ride_search') }}" method="GET"
                        ...
                        <div class="form-group  col-xl-3 col-lg-3 col-md-12 mb-3 bg-white ">
                        ...
                        <div class="form-group  col-xl-3 col-lg-3 col-md-12 mb-3 bg-white">
                            <input type="text" class="form-control input-lg br-md-0 border-end-0 place-suggestion pe-6"
                                name="destination" id="search_destination" placeholder="Destination" data-form="#form-search-ride-hero">
                            <span><img src="{{ asset('assets/images/icons/marker-icon.svg') }}" alt="" class="location-gps"></span>
                        ...
                        <div class="form-group col-xl-3 col-lg-3 col-md-10 col-sm-8 col-12 select2-lg mb-3 bg-white">
                        ...
                        <div class="form-group col-xl-1 col-lg-1 col-md-2 col-sm-4 col-8 select2-lg mb-3 bg-white">
                        ...
                        <div class="form-group col-xl-1 col-lg-1 col-md-2 col-sm-4 col-4 select2-lg mb-3 bg-white d-flex align-items-center">
                            passager
                        </div>
