...
<form id="booking-form-match" action="{{ route('ride_match') }}" class="form booking-form" method="POST">
    ...
    <div class="row">
        <div class="col-12 col-md-6">
            <div class="my-3">
                <input type="text" name="departure_address" id="departure_address" data-form="#booking-form-match" data-field="departure_label" class="form-control rounded-pill trajet-suggestion" placeholder="Adresse de départ" value="" required title="Adresse de départ">
        ...
        <div class="col-12 col-md-6">
            <div class="my-3">
                <input type="text" name="arrival_address" id="arrival_address" class="form-control rounded-pill trajet-suggestion" data-form="#booking-form-match" data-field="arrival_label" placeholder="Adresse d'arrivée" value="" required title="Adresse d'arrivée">
    ...
    <div class="row">
        <div class="col-12 col-md-6">
            <div class="my-3 input-group">
                <input type="date" name="departure_date" id="departure_date" class="form-control rounded-pill" placeholder="Date de départ" value="" required title="Date de départ">
        ...
        <div class="col-12 col-md-6">
            <div class="my-3 input-group">
                <input type="time" name="time" id="departure_time" class="form-control rounded-pill" placeholder="Heure de départ" value=""  aria-label="Heure de départ" aria-describedby="departure_time_icon" required title="Heure de départ">
