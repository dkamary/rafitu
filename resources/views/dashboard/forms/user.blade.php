...
@php
    $avatar = $user->avatar ? asset($user->avatar) : asset('assets/images/faces/male/1.jpg');
@endphp
...
<form method="POST" enctype="multipart/form-data" action="{{ route('dashboard_user') }}" class="form user-form">
    ...
    <div class="row my-2">
        ...
        <div class="col-12 col-md-8">
            <img src="{{ asset($avatar) }}" alt="{{ $user->firstname.'-'.$user->lastname }}" style="width: auto; height: 10rem;">
