...
<div class="row mb-4 rounded ride__result py-3 {{ $loop->even ? 'bg-light' : 'bg-white' }}">
    <div class="col-12">
        <div class="row">
            <div @class([
                'col-8' => $showPrice,
                ...
                <div class="ride__info py-3">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <h4>{{ $ride->getDepartureDate('d/m/Y') }}</h4>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="row ride__departure">
                        <div class="col-12 py-2">
                            ...
                            <h6>{{ $ride->getDepartureDate('H:m') }}</h6>
                        </div>
                    </div>
            ...
            @if($showPrice)
                <div class="col-4 py-3">
                    ...
                    @if($ride->woman_only)
                    <div class="row">
                        <div class="col-12 text-info">Femme seulement</div>
                    </div>
                    @endif
                </div>
            @endif
