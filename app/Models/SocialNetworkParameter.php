...
class SocialNetworkParameter extends Model
{
    ...
    public function hasFacebook() : bool {
        ...
        if(strlen(trim($this->facebook)) == 0) return false;
    ...
    public function hasInstagram() : bool {
        ...
        if(strlen(trim($this->instagram)) == 0) return false;
    ...
    public function hasTwitter() : bool {
        ...
        if(strlen(trim($this->twitter)) == 0) return false;
    ...
    public function hasLinkedin() : bool {
        ...
        if(strlen(trim($this->linkedin)) == 0) return false;
