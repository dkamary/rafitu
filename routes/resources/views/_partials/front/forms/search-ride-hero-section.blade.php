...
<form id="form-search-ride-hero" action="{{ route('ride_search') }}" method="GET" class="form row g-0 form-search-ride-hero">
    <div class="form-group  col-xl-3 col-lg-3 col-md-12 mb-0 bg-white ">
        <input type="text" class="form-control input-lg br-te-md-0 br-be-md-0 border-end-0 place-suggestion" name="origin" id="search_origin" placeholder="Départ" data-form="#form-search-ride-hero">
    ...
    <div class="form-group  col-xl-3 col-lg-3 col-md-12 mb-0 bg-white">
        <input type="text" class="form-control input-lg br-md-0 border-end-0 place-suggestion" name="destination" id="search_destination" placeholder="Destination" data-form="#form-search-ride-hero">
        <span><i class="fa fa-map-marker location-gps me-1"></i></span>
