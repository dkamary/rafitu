...
<html lang="en" dir="ltr">
	...
	<body class="app sidebar-mini">
			...
			<div class="page-main  h-100">
					...
					<div class="container-fluid">
						<div class="d-flex">
							<a class="header-brand" href="index.html">
								<img src="assets/images/brand/logo.png" class="header-brand-img light-logo" alt="Claylist logo">
								<img src="assets/images/brand/logo1.png" class="header-brand-img dark-logo" alt="Claylist logo">
							</a>
							...
							<div class="d-flex order-lg-2 ms-auto  header-right">
								<div class="header-navicon">
									<a href="#" data-bs-toggle="search" class="nav-link d-lg-none navsearch-icon">
									...
									<div class="navbar-collapse collapse" id="navbarSupportedContent-4">
										<div class="d-flex">
											...
											<div class="dropdown d-md-flex country-selector">
												<a href="#" class="d-flex nav-link leading-none" data-bs-toggle="dropdown">
													<img src="assets/images/us_flag.jpg" alt="img" class="avatar avatar-xs me-1 align-self-center">
													<div>
												...
												<div class="language-width dropdown-menu dropdown-menu-end dropdown-menu-arrow">
													<a href="#" class="dropdown-item d-flex pb-3">
														<img src="assets/images/french_flag.jpg"  alt="flag-img" class="avatar  me-3 align-self-center" >
														<div>
															<strong>French</strong>
														</div>
													</a>
													<a href="#" class="dropdown-item d-flex pb-3">
														<img src="assets/images/germany_flag.jpg"  alt="flag-img" class="avatar  me-3 align-self-center" >
														<div>
															<strong>Germany</strong>
														</div>
													</a>
													<a href="#" class="dropdown-item d-flex pb-3">
														<img src="assets/images/italy_flag.jpg"  alt="flag-img" class="avatar  me-3 align-self-center" >
														<div>
															<strong>Italy</strong>
														</div>
													</a>
													<a href="#" class="dropdown-item d-flex pb-3">
														<img src="assets/images/russia_flag.jpg"  alt="flag-img" class="avatar  me-3 align-self-center" >
														<div>
															<strong>Russia</strong>
														</div>
													</a>
													<a href="#" class="dropdown-item d-flex pb-3">
														<img src="assets/images/spain_flag.jpg"  alt="flag-img" class="avatar  me-3 align-self-center" >
														<div>
															<strong>Spain</strong>
														</div>
													</a>
											...
											<div class="dropdown d-md-flex">
												...
												<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
													...
													<a href="#" class="dropdown-item d-flex pb-3">
														<img src="assets/images/faces/female/1.jpg" alt="avatar-img" class="avatar brround me-3 align-self-center">
														<div>
													...
													<a href="#" class="dropdown-item d-flex pb-3">
														<img src="assets/images/faces/male/18.jpg" alt="avatar-img" class="avatar brround me-3 align-self-center">
														<div>
													...
													<a href="#" class="dropdown-item d-flex pb-3">
														<img src="assets/images/faces/female/18.jpg" alt="avatar-img" class="avatar brround me-3 align-self-center">
														<div>
				...
				<aside class="app-sidebar doc-sidebar">
					...
					<div class="app-sidebar-footer">
						<a href="emailservice.html"><span class="fa fa-envelope" aria-hidden="true"></span></a>
						<a href="profile1.html"><span class="fa fa-user" aria-hidden="true"></span></a>
						<a href="editprofile1.html"><span class="fa fa-cog" aria-hidden="true"></span></a>
						<a href="login.html"><span class="fa fa-sign-in" aria-hidden="true"></span></a>
						<a href="chat2.html"><span class="fa fa-comment" aria-hidden="true"></span></a>
					</div>
				</aside>
				<!-- Sidebar menu End-->
							...
							<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3 ">
								<div class="card overflow-hidden">
									...
									<div class="card-body ">
										...
										<div class="progress progress-sm mt-0 mb-2">
											<div class="progress-bar bg-success" style="width: 25%;" role="progressbar"></div>
										</div>
										...
										<div class="chats-wrap">
											<div class="chat-details p-2">
												<h6 class="mb-0">
													...
													<span class="float-end p-1">78%</span>
												</h6>
												<div class="progress progress-sm mt-3">
													<div class="progress-bar progress-bar-striped progress-bar-animated bg-success" style="width: 35%;"></div>
												</div>
											</div>
											<div class="chat-details p-2">
												<h6 class="mb-0">
													<span class="font-weight-normal">Satisfied</span>
													<span class="float-end p-1">82%</span>
												</h6>
												<div class="progress progress-sm mt-3">
											...
											<div class="chat-details p-2">
												<h6 class="mb-0">
													...
													<span class="float-end p-1">89%</span>
												</h6>
												<div class="progress progress-sm mt-3">
													<div class="progress-bar progress-bar-striped progress-bar-animated bg-secondary" style="width: 65%;"></div>
												</div>
											</div>
											<div class="chat-details p-2">
												<h6 class="mb-0">
													<span class="font-weight-normal">Average</span>
													<span class="float-end p-1">40%</span>
												</h6>
												<div class="progress progress-sm mt-3">
											...
											<div class="chat-details p-2">
												<h6 class="mb-0">
													...
													<span class="float-end p-1">20%</span>
												</h6>
												<div class="progress progress-sm mt-3">
										...
										<div class="ibox teams mb-30 bg-boxshadow">
											...
											<div class="ibox-content teams">
												...
												<div class="avatar-list avatar-list-stacked">
													<span class="avatar brround cover-image cover-image" data-bs-image-src="assets/images/faces/female/12.jpg" ></span>
													<span class="avatar brround cover-image cover-image" data-bs-image-src="assets/images/faces/female/21.jpg" ></span>
													<span class="avatar brround cover-image cover-image" data-bs-image-src="assets/images/faces/female/29.jpg"></span>
													<span class="avatar brround cover-image cover-image" data-bs-image-src="assets/images/faces/female/2.jpg"></span>
													<span class="avatar brround cover-image cover-image" data-bs-image-src="assets/images/faces/male/34.jpg"></span>
						...
						<div class="row">
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="custom-controls-stacked checklist-task">
											<label class="custom-control form-checkbox mb-3 checklist-desc">
												...
												<div class="check-data d-flex mt-1">
													...
													<div class="check-icon ms-auto">
														<span class="text-muted" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit"><i class="fa fa-pencil-square-o "></i> </span>
														<span class="text-muted" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Delete"><i class="fa fa-trash-o"></i></span>
													</div>
												</div>
											</label>
											<label class="custom-control form-checkbox mb-3 checklist-desc">
											...
											<label class="custom-control form-checkbox checklist-desc">
									...
									<div class="card-body">
										...
										<div class="item-card7-text">
											<ul class="icon-card mb-0">
												<li class=""><a href="#" class="icons"><i class="icon icon-location-pin text-muted me-1"></i>  Los Angles</a></li>
												<li><a href="#" class="icons"><i class="icon icon-event text-muted me-1"></i> 5 hours ago</a></li>
												<li class="mb-0"><a href="#" class="icons"><i class="icon icon-user text-muted me-1"></i> Sally Peake</a></li>
												<li class="mb-0"><a href="#" class="icons"><i class="icon icon-phone text-muted me-1"></i> 567 9876 087</a></li>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<div class="item-card7-desc">
											<a href="#" class="text-dark"><h4 class="font-weight-semibold">Hair dresser-Beauticia</h4></a>
										</div>
										<div class="item-card7-text">
											<ul class="icon-card mb-0">
												<li class=""><a href="#" class="icons"><i class="icon icon-location-pin text-muted me-1"></i>  Los Angles</a></li>
												<li><a href="#" class="icons"><i class="icon icon-event text-muted me-1"></i> 5 hours ago</a></li>
												<li class="mb-0"><a href="#" class="icons"><i class="icon icon-user text-muted me-1"></i> Sally Peake</a></li>
												<li class="mb-0"><a href="#" class="icons"><i class="icon icon-briefcase text-muted me-1"></i>Beauty Span</a></li>
											</ul>
										</div>
									</div>
								</div>
		...
		<!-- Fullside-menu Js-->
		<script src="assets/plugins/toggle-sidebar/sidemenu2.js"></script>
